...
const TEMPLATES = [
  {
    ...
    preview: { bg: "#4A4558", text: "#ffffff", highlight: "#3ECFB2", chip: "#3ECFB2", chipText: "#1D5C4A" },
    canvas: { bg: "#4A4558", text: "#ffffff", highlight: "#3ECFB2", chip: "#3ECFB2", chipText: "#1A1A1A" },
  },
  {
    id: "teal",
    label: "Teal",
    description: "Deep teal · white text · gold highlights",
    preview: { bg: "#1D5C4A", text: "#ffffff", highlight: "#F5C842", chip: "#F5C842", chipText: "#1D5C4A" },
    canvas: { bg: "#1D5C4A", text: "#ffffff", highlight: "#F5C842", chip: "#F5C842", chipText: "#1D5C4A" },
  },
  {
    id: "breaking",
    label: "Breaking",
    description: "Black · white text · terracotta highlights",
    preview: { bg: "#111111", text: "#ffffff", highlight: "#C1673A", chip: "#C1673A", chipText: "#ffffff" },
    canvas: { bg: "#111111", text: "#ffffff", highlight: "#C1673A", chip: "#C1673A", chipText: "#ffffff" },
  },
];
