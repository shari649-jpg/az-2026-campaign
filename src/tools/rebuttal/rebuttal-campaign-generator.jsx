  ...
  return (
    <div style={S.app}>
      ...
      <header style={S.header}>
        <div style={S.hLeft}>
          <span style={S.eyebrow}>Rapid Rebuttal System</span>
          <h1 style={S.h1}>Campaign Generator</h1>
          <p style={S.sub}>Anchor phrase · 3 lenses · up to 3 activists · 6 platforms · posts + first comments</p>
        </div>
        <div style={S.hRight}>
          {library.length > 0 && (
