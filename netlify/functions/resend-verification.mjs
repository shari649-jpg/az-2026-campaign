      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:36px 40px;">
            ...
            <p style="margin:0 0 28px;font-size:15px;color:#362A44;line-height:1.7;">Your Comms Hub account is created, but your email still needs to be verified before you can sign in. Click below to finish activating your account.</p>
            <table cellpadding="0" cellspacing="0" width="100%">
              <tr><td align="center" style="padding:8px 0 24px;">
                <a href="${link}" style="display:inline-block;background:#4A3163;color:#fff;text-decoration:none;font-size:16px;font-weight:700;padding:16px 40px;border-radius:8px;letter-spacing:0.04em;">Verify my email →</a>
              </td></tr>
            </table>
