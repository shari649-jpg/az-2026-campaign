...
//
// Called from RegisterPage.jsx immediately after a successful registration.
// Sends a welcome email with quick-start info via Resend.
//
// FROM address: onboarding@resend.dev (swap for your domain once verified)
// TO address:   the newly registered user
//
// Required env vars:
...
<head>
  ...
  <title>Welcome to the AZ Coalition Comms Hub</title>
</head>
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background:#1D5C4A;padding:32px 40px;text-align:center;">
            ...
            <h1 style="margin:0;font-size:26px;font-weight:700;color:#ffffff;line-height:1.2;">Welcome to the Comms Hub!</h1>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:36px 40px;">
            <p style="margin:0 0 20px;font-size:16px;color:#4A4558;line-height:1.7;">
              Hi <strong>${fullName}</strong> — you're in! Here's how to hit the ground running:
            </p>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:28px;">
              ...
              <tr>
                ...
                <td style="padding:12px 0 12px 14px;border-bottom:1px solid #f0f0ec;vertical-align:top;">
                  ...
                  <div style="font-size:14px;color:#666;line-height:1.6;">Generate platform-ready social media posts tailored to issue, audience, and style. Start here for your first campaign message.</div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="padding:12px 0 12px 14px;border-bottom:1px solid #f0f0ec;vertical-align:top;">
                  ...
                  <div style="font-size:14px;color:#666;line-height:1.6;">Look up candidate profiles, compare races, and explore district demographics — all from your coalition's live data.</div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="padding:12px 0 12px 14px;border-bottom:1px solid #f0f0ec;vertical-align:top;">
                  ...
                  <div style="font-size:14px;color:#666;line-height:1.6;">Paste a news article URL to get an instant structured breakdown — key facts, people, quotes — ready to fuel your messaging.</div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="padding:12px 0 12px 14px;border-bottom:1px solid #f0f0ec;vertical-align:top;">
                  ...
                  <div style="font-size:14px;color:#666;line-height:1.6;">Counter misinformation fast. Enter the false narrative and get targeted rebuttals for your activists and key profiles.</div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="padding:12px 0 12px 14px;vertical-align:top;">
                  ...
                  <div style="font-size:14px;color:#666;line-height:1.6;">Every campaign and article you save goes here. Reload, share, and build on past work across your coalition.</div>
                </td>
              </tr>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
              <tr><td align="center" style="padding:8px 0 24px;">
                <a href="${SITE_URL}" style="display:inline-block;background:#1D5C4A;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;padding:16px 40px;border-radius:8px;letter-spacing:0.04em;">
                  Open the Comms Hub →
                </a>
              </td></tr>
            </table>
            ...
            <p style="margin:0;font-size:13px;color:#aaa;line-height:1.6;text-align:center;">
              Need help? Visit the Quick Start Guide inside the app under the More menu.
            </p>
          </td>
        </tr>
...
export default async function (req) {
  ...
  try {
    ...
    if (!resendRes.ok) {
      ...
      console.error("[send-welcome] Resend error:", errData);
      // Non-fatal — registration already succeeded, don't fail the user
      return new Response(JSON.stringify({ success: false, detail: errData }), {
